...
namespace ShopSite.Server.Areas.Administrator.Controllers
{
    public class ItemAddController : Controller
    {
        ...
        public ActionResult Items_Create([DataSourceRequest]DataSourceRequest request, Item item)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Items_Destroy([DataSourceRequest]DataSourceRequest request, Item item)
        {
            if (ModelState.IsValid)
            {
                var entity = new Item
